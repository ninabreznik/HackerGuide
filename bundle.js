...
var _templateObject = _taggedTemplateLiteral(['<link href=', ' rel=\'stylesheet\' type=\'text/css\'>'], ['<link href=', ' rel=\'stylesheet\' type=\'text/css\'>']),
    ...
    _templateObject3 = _taggedTemplateLiteral(['\n    \t\t<div class=\'', '\'>\n          <div class=\'', '\'>Taipei guide for hackers</div>\n          ', '\n          ', '\n          ', '\n          ', '\n          ', '\n          ', '\n          ', '\n          ', '\n          ', '\n          ', '\n        </div>\n    '], ['\n    \t\t<div class=\'', '\'>\n          <div class=\'', '\'>Taipei guide for hackers</div>\n          ', '\n          ', '\n          ', '\n          ', '\n          ', '\n          ', '\n          ', '\n          ', '\n          ', '\n          ', '\n        </div>\n    ']),
...
/*------------------------------------------
                CSS
-------------------------------------------*/
var css = csjs(_templateObject2, BLUEISH, FONT, BLUEISH, WHITISH, WHITISH, WHITISH, WHITISH, REDISH, BLUEISH, WHITISH, WHITISH, YELLOWISH);
/*------------------------------------------
              HTML
-------------------------------------------*/
  ...
  var showHide = {
    list: function list(data) {
      ...
      return array.map(function (x) {
        return yo(_templateObject4, css.item, x.link, x.name);
      });
    },
...
function menuButtonComponent(data, title, route, image) {
  var css = csjs(_templateObject7, FONT, image, WHITISH, BLUEISH);
